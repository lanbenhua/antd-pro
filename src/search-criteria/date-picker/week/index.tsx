...
class WeekPicker<TValue extends IDatePickerValue> extends AbstractDatePicker<
  TValue,
  WeekPickerProps<TValue>
> {
  public renderPicker() {
    ...
    return (
      <AntdDatePicker.WeekPicker
        ...
        className={cls(
          ...
          'search-criteria-datepicker-week-picker'
        )}
        value={value}
        onChange={v => {
  ...
  public renderSelectorValue(value?: TValue | undefined): React.ReactNode {
    const { format = 'YYYY/wo', renderSelectorValue } = this.props;
